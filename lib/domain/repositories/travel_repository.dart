...
abstract class TravelRepository {
  ...
  Future<int> update(DatabaseExecutor txn, Travel travel);
  Future<void> delete(int travelId);
  Future<void> associateParticipantWithTravel(DatabaseExecutor txn, int participantId, int travelId);
  Future<Travel?> getById(int id);
  Future<TravelWithDetails> getTravelWithDetails(int travelId);
  Future<void> unassociateAllParticipants(DatabaseExecutor txn, int travelId);
}
