...
import 'package:travel_app/presentation/screens/travel_stop_experience_screen.dart';
  ...
  static Map<String, WidgetBuilder> get routes =>
      {
        ...
        '/stop-details': (context) {
          final stopId = ModalRoute
              .of(context)!
              .settings
              .arguments as int;
          return ChangeNotifierProvider<ExperienceProvider>(
            create: (context) =>
                ExperienceProvider(
                  ServiceLocator().addExperienceUseCase,
                  ServiceLocator().listExperiencesUseCase,
                  ServiceLocator().removeExperienceUseCase,
                ),
            child: TravelStopExperienceScreen(stopId: stopId),
          );
        },
      };
}
